...
const MIC_DATA = {
    ...
    "fm": { // Micronesia, Federated States of
        ...
        diplomacy: { status: "full_relations", summary: "Maintains relations via non-resident ambassador. Strongly aligned with US/Israel." },
        irgc: { status: "rejected_or_no", summary: "No designation." },
        un: { status: "supports_accountability", summary: "Consistently votes against Iran on HR and Israel-related resolutions." },
        security: { status: "conditional_support", summary: "US Compact of Free Association state." }
    },
    "ki": { // Kiribati
        name: "Kiribati",
        region: "Oceania",
    ...
    "mh": { // Marshall Islands
        ...
        scores: { diplomacy: 10, irgc: 0, un: 10, security: 5 },
        force_tier: "C", // Targeted Pressure
        diplomacy: { status: "full_relations", summary: "Maintains relations. Strongly aligned with US/Israel." },
        irgc: { status: "rejected_or_no", summary: "No designation." },
        un: { status: "supports_accountability", summary: "Consistently votes against Iran/with Israel." },
        security: { status: "conditional_support", summary: "US Compact of Free Association state." }
    },
    "nr": { // Nauru
        name: "Nauru",
        ...
        force_tier: "C", // Targeted Pressure
        diplomacy: { status: "full_relations", summary: "Maintains relations. Strongly aligned with Israel." },
        irgc: { status: "rejected_or_no", summary: "No designation." },
        un: { status: "supports_accountability", summary: "Consistently votes against Iran/with Israel." },
        security: { status: "unknown", summary: "None known." }
    },
...
Object.entries(MIC_DATA).forEach(([iso2, data]) => {
