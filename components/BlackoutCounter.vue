...
<template>
    <div class="flex flex-col items-center justify-center p-8 bg-surface-0 dark:bg-surface-900 text-surface-900 dark:text-surface-0 rounded-xl shadow-lg border border-surface-200 dark:border-surface-800 space-y-4 max-w-2xl mx-auto">
        ...
        <div class="mt-4 text-xs text-surface-600 dark:text-surface-400 text-center max-w-lg leading-relaxed bg-surface-50 dark:bg-surface-800 p-4 rounded-lg border border-surface-200 dark:border-surface-700 space-y-3 shadow-inner">
            <div>
                <span class="block mb-1 font-bold text-surface-700 dark:text-surface-300">Update (Jan 27, 14:05):</span>
                <a href="https://x.com/netblocks/status/2016150516154147216?s=20" target="_blank" class="text-primary-600 dark:text-primary-400 hover:underline">NetBlocks reported</a>: With Iran's internet shutdown approaching day 20, many networks are becoming visible internationally. However, web remains heavily filtered on a whitelist basis. The opening of protocols can enable new workarounds, but no return to usual is observed.
            </div>
        </div>
    </div>
</template>
