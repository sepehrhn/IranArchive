...
<template>
    <Tag v-if="status === 'verified'" icon="pi pi-check-circle" severity="success" value="Verified" rounded class="!bg-green-100 !text-green-700 dark:!bg-green-500/20 dark:!text-green-400"></Tag>
