...
export const verifiedHistoricalIncidentBatch: Incident[] = seeds.map((s, index) => ({
  ...
  review_history:[{at:'2026/07/29',reviewer:'Sepehr',change:'created',to_status:'verified',notes:'Source-backed batch; ratings reflect public reviewability, not legal adjudication.'}],
  victims:[],
  related_incidents:[]
} as Incident))
